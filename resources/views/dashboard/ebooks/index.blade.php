...
@section('breadcrumb-items')
    <li class="breadcrumb-item active">{{ __('Ebooks') }}</li>
@endsection
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header">
                @canany(['create ebook'])
                    <a href="{{route('dashboard.ebooks.create')}}" class="add-new btn btn-primary waves-effect waves-light">
                        <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                            class="d-none d-sm-inline-block">{{ __('Add New Ebook') }}</span>
                    </a>
                @endcan
            </div>
                ...
                <table class="datatables-users table border-top custom-json-datatables">
                    <thead>
                        <tr>
                            ...
                            @canany(['delete ebook', 'update ebook'])<th>{{ __('Action') }}</th>@endcan
                        </tr>
                    </thead>
                </table>
            </div>
            ...
            $(function () {
                $('.custom-json-datatables').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'ebook', name: 'ebook', orderable: false, searchable: false },
