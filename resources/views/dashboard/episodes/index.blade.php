    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header">
                @canany(['create episode'])
                    <a href="{{route('dashboard.episodes.create')}}" class="add-new btn btn-primary waves-effect waves-light">
                        <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                            class="d-none d-sm-inline-block">{{ __('Add New Episode') }}</span>
                    </a>
                @endcan
            </div>
                ...
                <table class="datatables-users table border-top custom-json-datatables">
                    <thead>
                        <tr>
                            ...
                            @canany(['delete episode', 'update episode'])<th>{{ __('Action') }}</th>@endcan
                        </tr>
                    </thead>
                </table>
            </div>
