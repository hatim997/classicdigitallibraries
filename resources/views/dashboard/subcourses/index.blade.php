...
@section('breadcrumb-items')
    <li class="breadcrumb-item active">{{ __('Sub Courses') }}</li>
@endsection
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <!-- Sub Courses List Table -->
        <div class="card">
            <div class="card-header">
                @canany(['create course'])
                    <a href="{{route('dashboard.subcourses.create')}}" class="add-new btn btn-primary waves-effect waves-light">
                        <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                            class="d-none d-sm-inline-block">{{ __('Add New Sub Course') }}</span>
                    </a>
                @endcan
            </div>
                ...
                <table class="datatables-users table border-top custom-json-datatables">
                    <thead>
                        <tr>
                            ...
                            @canany(['delete sub course', 'update sub course'])<th>{{ __('Action') }}</th>@endcan
                        </tr>
                    </thead>
                </table>
            </div>
