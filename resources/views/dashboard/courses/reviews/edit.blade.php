...
@section('title', __('Edit Course Review'))
...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active"><a href="{{route('dashboard.courses.reviews', $review->course_id)}}">{{ __('Courses Reviews') }}</a></li>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
            ...
            <div class="card-body pt-4">
                <form method="POST" action="{{ route('dashboard.courses.reviews.update', $review->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row p-5">
                        <h3>{{ __('Edit Course Review') }}</h3>
                    ...
                    <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-3">{{ __('Update Course Review') }}</button>
                    </div>
                </form>
            </div>
            <!-- /Account -->
